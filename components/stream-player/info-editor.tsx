...
export default function StreamInfoEditor({userProfileModel, streamModel, className}: StreamInfoProps) {
  return (
    <div className={cn("rounded-xl border", className)}>
      <div className={"p-4 flex space-x-4 items-center border-b"}>
        <div className={"p-2 w-fit rounded bg-primary-blue flex-none"}>
